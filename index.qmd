...
XParams is a Python library to manage large and complex parameters. It was born while developing our agent-based model simulation of the economy calle Aizle ( [https://aizle.ai](https://aizle.ai)).
...
```bash
XPARAMS=myrun python myscript.py
```
:::
